...
import 'package:stc_health_app/Presentation/Widgets/Dashboard/Localisation/Component/localizationText.dart';
...
class CustomAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  CustomAppBar(
      ...
      required this.title,
      this.isHome = false,
      this.isShowNotificationButton = true,
      this.onBackTap})
    ...
    return AppBar(
      ...
      shape: ContinuousRectangleBorder(
        borderRadius: BorderRadius.only(
            ...
            bottomRight: Radius.circular(60.r)), // Adjust the radius as needed
      ),
      title: Padding(
