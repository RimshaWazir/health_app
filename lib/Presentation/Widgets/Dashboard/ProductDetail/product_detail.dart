...
import 'package:stc_health_app/Presentation/Common/image_widgets.dart';
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Colors.black.withOpacity(0.000099),
              AppColors.darkBrownColor.withOpacity(0.7)
            ],
          ),
        ),
        child: Column(
                      ...
                      builder: (context, lState) {
                        return Padding(
                          padding: EdgeInsets.only(
                              left: lState == true ? 10.0 : 0,
                              right: lState == false ? 10 : 0),
                          child: Align(
            ...
            ValueListenableBuilder(
              builder: (context, state, ch) {
                return AnimatedContainer(
                  ...
                  height: state == false
                      ? 1.sh - (1.sh / 2) - (1.sh / 4.5)
                      : 1.sh - (1.sh / 2) - (1.sh / 8.5),
                  decoration: BoxDecoration(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: Align(
                              child: state == false
                                  ? SvgPicture.asset(Assets.arrowUpIcon)
                                    ...
                                    children: [
                                      ...
                                      BlocBuilder<LocaleCubit, bool?>(
                                        builder: (context, lState) {
                                          return Padding(
                                            padding: EdgeInsets.only(
                                                left: lState == true ? 8.0 : 0,
                                                right: lState == false ? 8 : 0),
                                            child: Align(
                                                alignment: lState == true
                                                    ? Alignment.centerLeft
                                                    : Alignment.centerRight,
                                                child: AppText(
                                                    '${'Reviews'.tr()} (${pd.rating!.count!})',
                                                    style: Styles
                                                        .openSansStdMedium(
                                                            context,
                                                            color: AppColors
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Align(
                                                alignment: Alignment.centerLeft,
                                                child: AppText(
                                                    pd.rating!.rate!.toString(),
                                                    style:
                                                        Styles.openSansStdBold(
                                                            context,
                                                            color: AppColors
                                                                .blackColor,
                                                            fontSize: 20.sp))),
